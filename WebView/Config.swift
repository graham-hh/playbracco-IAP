...
var purchasecode = "41ac66f7-311c-4c28-9330-e38dadfdc038"
...
var safariblacklist = [host, "sbet.bracco.linepros.com", "s01bet.bracco.linepros.com",] //Add domains here that should NEVER be opened in Safari, regardless of what the openallexternalurlsinsafaribydefault option is set to; to add another domain, insert another host like so: ["alwaysopeninsafari.com", "google.com", "m.facebook.com"] please enter the host exactly how you link to it (with or without www, but always without http/https)
...
let enableBioMetricAuth = true  //Set to true to enable Face ID/Touch ID/Code authentication required for the app (this is an independent/additional option to our JavaScript-based Bio Auth API, see documentation)
...
var statusBarBackgroundColor = #colorLiteral(red: 0.9450980392, green: 0.337254902, blue: 0.1333333333, alpha: 1) //Define a custom status bar background color

var darkModeStatusBarBackgroundColor = #colorLiteral(red: 0.9450980392, green: 0.337254902, blue: 0.1333333333, alpha: 1) //Define a custom status bar background color while user is using iOS Dark Mode
...
var bottombarBackgroundColor = #colorLiteral(red: 0.9450980392, green: 0.337254902, blue: 0.1333333333, alpha: 1) //Define a custom bottom bar background color

var darkmodeBottombarBackgroundColor = #colorLiteral(red: 0.9450980392, green: 0.337254902, blue: 0.1333333333, alpha: 1) //Define a custom bottom bar background color while user is using iOS Dark Mode; requires iOS 13 or higher
...
var scaleSplashImage = 50    //Set the splash screen image size with respect to the device's smallest width/height; range in percentage [0-100]; value = 0 will hide the image completely, value = 100 will display the image in full-screen mode
...
var loadingIndicatorColor = #colorLiteral(red: 0.3411764706, green: 0.0862745098, blue: 0, alpha: 1) //Set a color for the loading indicator
...
static let splashscreencolor = #colorLiteral(red: 0.9450980392, green: 0.337254902, blue: 0.1333333333, alpha: 1) //Set a background color for the splash screen
...
static let firebaseTopic = "PlayBracco" //Optional: set a Firebase Topic to subscribe to
